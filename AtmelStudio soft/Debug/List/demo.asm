...
_0x0:
	.DB  0x55,0x3D,0x20,0x0,0x49,0x3D,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2020060:
	.DB  0x1
...
; 0000 003A 	ftoa(voltage, 1, lcd_buffer_voltage);
	...
	LDI  R30,LOW(1)
	ST   -Y,R30
	LDI  R26,LOW(_lcd_buffer_voltage)
	LDI  R27,HIGH(_lcd_buffer_voltage)
	RCALL _ftoa
...
; 0000 0041 	ftoa(current, 2, lcd_buffer_current);
	...
	LDI  R30,LOW(2)
	ST   -Y,R30
	LDI  R26,LOW(_lcd_buffer_current)
	LDI  R27,HIGH(_lcd_buffer_current)
	RCALL _ftoa
